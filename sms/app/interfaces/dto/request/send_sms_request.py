...
class SendSmsRequest(BaseModel):
     ...
     def validate_message(cls, v):
         ...
         if len(v) > 200:
             raise ValueError("number of characters is too Long")
         else:
             return v
     ...
     def validate_iranian_mobile_number(cls, v):
         ...
         if v.startswith("09"):
             v = "+98" + v[1:]  # remove '0', keep rest
         elif not v.startswith("+98"):
             raise ValueError("Phone number must start with +98 or 09")
