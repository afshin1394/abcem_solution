...
dag = DAG(
    dag_id='update_speed_test_servers_dag',
    default_args=default_args,
    description='Init update speed test servers dag',
    schedule_interval=None,
    catchup=False,
    tags=['speed_test_servers_init'],
)

PythonOperator(
    task_id='update_speed_test_servers_in_core',
