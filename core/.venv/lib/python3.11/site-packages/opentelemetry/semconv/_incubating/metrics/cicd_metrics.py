...
"""
The number of errors in a component of the CICD system (eg. controller, speed_test, agent)
Instrument: counter
Unit: {error}
...
def create_cicd_system_errors(meter: Meter) -> Counter:
    ...
    return meter.create_counter(
        ...
        description="The number of errors in a component of the CICD system (eg. controller, speed_test, agent).",
        unit="{error}",
    )
