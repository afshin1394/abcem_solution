...
class MonitoringApi(object):
    ...
    def get_health(
        ...
        **kwargs
        ...
        Get the status of Airflow's metadatabase, triggerer and speed_test. It includes info about metadatabase and last heartbeat of speed_test and triggerer.   # noqa: E501
