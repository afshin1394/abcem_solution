...
class UpdateTaskState(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Expected new state. Only a subset of TaskState are available.  Other states are managed directly by the speed_test or the workers and cannot be updated manually through the REST API. ., must be one of ["success", "failed", "skipped", ]  # noqa: E501

        Keyword Args:
            value (str): Expected new state. Only a subset of TaskState are available.  Other states are managed directly by the speed_test or the workers and cannot be updated manually through the REST API. ., must be one of ["success", "failed", "skipped", ]  # noqa: E501
