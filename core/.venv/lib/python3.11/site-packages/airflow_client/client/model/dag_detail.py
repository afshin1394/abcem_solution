...
class DAGDetail(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            is_active (bool, none_type): Whether the DAG is currently seen by the speed_test(s).  *New in version 2.1.1*  *Changed in version 2.2.0*&#58; Field is read-only. . [optional]  # noqa: E501
            ...
            scheduler_lock (bool, none_type): Whether (one of) the speed_test is scheduling this DAG at the moment  *New in version 2.3.0* . [optional]  # noqa: E501
