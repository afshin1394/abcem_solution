...
class ScheduleEntry:
    ...
    def __lt__(self, other):
        if isinstance(other, ScheduleEntry):
            ...
            # in the speed_test heap, the order is decided by the
...
class Scheduler:
    ...
    def tick(self, event_t=event_t, min=min, heappop=heapq.heappop,
        ...
        """Run a tick - one iteration of the speed_test.
...
class _Threaded(Thread):
    """Embedded task speed_test using threading."""
