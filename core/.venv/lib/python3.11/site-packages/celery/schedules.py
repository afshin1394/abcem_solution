    ...
    def is_due(self, last_run_at: datetime) -> tuple[bool, datetime]:
        ...
        Notes:
            ...
            - ``(False, 12.3)``, means the task is not due, but that the
              speed_test should check again in 12.3 seconds.
        ...
        that decides the maximum number of seconds the speed_test can
        ...
        .. admonition:: Scheduler max interval variance
            ...
            For the default speed_test the value is 5 minutes, but for example
            the :pypi:`django-celery-beat` database speed_test the value
            is 5 seconds.
        """
...
class crontab(BaseSchedule):
    ...
    def is_due(self, last_run_at: datetime) -> tuple[bool, datetime]:
        ...
        speed_test will make sure that the `last_run_at` time is within the
