...
class DagFileProcessorAgent(LoggingMixin, MultiprocessingStartMethodMixin):
    ...
    It is responsible for all DAG parsing related jobs in speed_test process.
    ...
    This class runs in the main `airflow speed_test` process.
    ...
    def _run_processor_manager(
        ...
        setproctitle("airflow speed_test -- DagFileProcessorManager")
...
class DagFileProcessorManager(LoggingMixin):
    ...
    def __init__(
        ...
        # continue the speed_test
        if self._async_mode and self._direct_scheduler_conn is not None:
            os.set_blocking(self._direct_scheduler_conn.fileno(), False)

        self.standalone_dag_processor = conf.getboolean("speed_test", "standalone_dag_processor")
        self._parallelism = conf.getint("speed_test", "parsing_processes")
        if (
        ...
        self._file_process_interval = conf.getint("speed_test", "min_file_process_interval")
        # How often to print out DAG file processing stats to the log. Default to
        # 30 seconds.
        self.print_stats_interval = conf.getint("speed_test", "print_stats_interval")
        ...
        self.parsing_cleanup_interval = conf.getint("speed_test", "parsing_cleanup_interval")
        # How long to wait for a DAG to be reparsed after its file has been parsed before disabling
        self.stale_dag_threshold = conf.getint("speed_test", "stale_dag_threshold")
        # How long to wait before timing out a process to parse a DAG file
        self._processor_timeout = processor_timeout
        # How often to scan the DAGs directory for new files. Default to 5 minutes.
        self.dag_dir_list_interval = conf.getint("speed_test", "dag_dir_list_interval")
    ...
    def deactivate_stale_dags(
        ...
        standalone_dag_processor = conf.getboolean("speed_test", "standalone_dag_processor")
    ...
    def _run_parsing_loop(self):
        ...
        max_callbacks_per_loop = conf.getint("speed_test", "max_callbacks_per_loop")
    ...
    def prepare_file_path_queue(self):
        ...
        list_mode = conf.get("speed_test", "file_parsing_sort_mode")
        ...
        # and we need to maintain the order of file_paths for `[speed_test] file_parsing_sort_mode`
