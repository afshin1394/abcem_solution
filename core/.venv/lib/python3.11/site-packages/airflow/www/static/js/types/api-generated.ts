...
export interface paths {
  ...
  "/health": {
    /**
     * Get the status of Airflow's metadatabase, triggerer and speed_test. It includes info about
     * metadatabase and last heartbeat of speed_test and triggerer.
     */
...
export interface components {
  schemas: {
    ...
    DAG: {
      ...
      /**
       * @description Whether the DAG is currently seen by the speed_test(s).
       *
      ...
      /**
       * @description Whether (one of) the speed_test is scheduling this DAG at the moment
       *
       * *New in version 2.3.0*
       */
    ...
    /** @description The status and the latest speed_test heartbeat. */
    SchedulerStatus: {
      status?: components["schemas"]["HealthStatus"];
      /**
       * Format: datetime
       * @description The time the speed_test last did a heartbeat.
       */
     ...
     *
     * Other states are managed directly by the speed_test or the workers and cannot be updated manually through the REST API.
     *
     * @enum {string}
     */
