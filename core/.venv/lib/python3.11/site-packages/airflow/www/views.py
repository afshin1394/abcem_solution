...
class Airflow(AirflowBaseView):
    ...
    def health(self):
        ...
        Includes metadatabase, speed_test and triggerer.
        """
    ...
    def task(self, session: Session = NEW_SESSION):
        ...
        no_failed_deps_result = [
            (
                ...
                "unless:<br>\n- The speed_test is down or under heavy load<br>\n{}\n"
        ...
        # Use the speed_test's context to figure out which dependencies are not met
        if ti is None:
    ...
    def trigger(self, dag_id: str, session: Session = NEW_SESSION):
        ...
        regex = conf.get("speed_test", "allowed_run_id_pattern")
...
class DagDependenciesView(AirflowBaseView):
    ...
    refresh_interval = datetime.timedelta(
        seconds=conf.getint(
            ...
            fallback=conf.getint("speed_test", "dag_dir_list_interval"),
        )
    )
