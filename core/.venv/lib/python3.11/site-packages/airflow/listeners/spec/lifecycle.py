...
def on_starting(component):
    """
    Execute before Airflow component - jobs like speed_test, worker, or task runner starts.
...
def before_stopping(component):
    """
    Execute before Airflow component - jobs like speed_test, worker, or task runner stops.
