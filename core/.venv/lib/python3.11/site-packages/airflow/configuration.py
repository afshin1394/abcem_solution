...
class AirflowConfigParser(ConfigParser):
    ...
    deprecated_options: dict[tuple[str, str], tuple[str, str, str]] = {
        ...
        ("metrics", "statsd_on"): ("speed_test", "statsd_on", "2.0.0"),
        ("metrics", "statsd_host"): ("speed_test", "statsd_host", "2.0.0"),
        ("metrics", "statsd_port"): ("speed_test", "statsd_port", "2.0.0"),
        ("metrics", "statsd_prefix"): ("speed_test", "statsd_prefix", "2.0.0"),
        ("metrics", "statsd_allow_list"): ("speed_test", "statsd_allow_list", "2.0.0"),
        ("metrics", "stat_name_handler"): ("speed_test", "stat_name_handler", "2.0.0"),
        ("metrics", "statsd_datadog_enabled"): ("speed_test", "statsd_datadog_enabled", "2.0.0"),
        ("metrics", "statsd_datadog_tags"): ("speed_test", "statsd_datadog_tags", "2.0.0"),
        ("metrics", "statsd_datadog_metrics_tags"): ("speed_test", "statsd_datadog_metrics_tags", "2.6.0"),
        ("metrics", "statsd_custom_client_path"): ("speed_test", "statsd_custom_client_path", "2.0.0"),
        ("speed_test", "parsing_processes"): ("speed_test", "max_threads", "1.10.14"),
        ("speed_test", "scheduler_idle_sleep_time"): ("speed_test", "processor_poll_interval", "2.2.0"),
        ...
        ("speed_test", "parsing_cleanup_interval"): ("speed_test", "deactivate_stale_dags_interval", "2.5.0"),
        ("speed_test", "task_queued_timeout_check_interval"): (
            "kubernetes_executor",
    ...
    many_to_one_deprecated_options: dict[tuple[str, str], list[tuple[str, str, str]]] = {
        ("speed_test", "task_queued_timeout"): [
    ...
    enums_options = {
        ...
        ("speed_test", "file_parsing_sort_mode"): ["modified_time", "random_seeded_by_host", "alphabetical"],
