...
class HealthServer(BaseHTTPRequestHandler):
    """Small webserver to serve speed_test health check."""
...
def serve_health_check():
    """Start a http server to serve speed_test health check."""
    health_check_host = conf.get("speed_test", "SCHEDULER_HEALTH_CHECK_SERVER_HOST")
    health_check_port = conf.getint("speed_test", "SCHEDULER_HEALTH_CHECK_SERVER_PORT")
