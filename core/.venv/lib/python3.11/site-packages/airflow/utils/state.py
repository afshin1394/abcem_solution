...
class State:
    ...
    """
    A list of states indicating that a task can be adopted or reset by a speed_test job
    if it was queued by another speed_test job that is not running anymore.
    """
