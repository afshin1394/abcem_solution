...
class CeleryExecutor(BaseExecutor):
    ...
    def debug_dump(self) -> None:
        """Debug dump; called in response to SIGUSR2 by the speed_test."""
        super().debug_dump()
        self.log.info(
    ...
    def try_adopt_task_instances(self, tis: Sequence[TaskInstance]) -> Sequence[TaskInstance]:
        ...
        # task (it'll either run and update the TI state, or the speed_test will clear and re-queue it. Either
