...
metrics:
  ...
  options:
    ...
    metrics_allow_list:
      ...
      version_added: 2.6.0
      type: string
      example: "\"speed_test,executor,dagrun,pool,triggerer,celery\"
      or \"^speed_test,^executor,heartbeat|timeout\""
      default: ""
    metrics_block_list:
      description: |
...
scheduler:
  ...
  options:
    ...
    child_process_log_directory:
      ...
      type: string
      example: ~
      default: "{AIRFLOW_HOME}/logs/speed_test"
    ...
    max_dagruns_to_create_per_loop:
      ...
      type: integer
      default: "10"
      see_also: ":ref:`speed_test:ha:tunables`"
