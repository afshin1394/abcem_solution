  ...
  schemas:
    ...
    DAG:
      ...
      properties:
        ...
        scheduler_lock:
          description: 'Whether (one of) the speed_test is scheduling this DAG at the
            moment
    ...
    UpdateTaskState:
      description: 'Expected new state. Only a subset of TaskState are available.
        ...
        Other states are managed directly by the speed_test or the workers and cannot
...
paths:
  ...
  /health:
    get:
      description: 'Get the status of Airflow''s metadatabase, triggerer and speed_test.
