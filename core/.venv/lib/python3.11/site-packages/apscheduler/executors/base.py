...
class BaseExecutor(metaclass=ABCMeta):
    ...
    def start(self, scheduler, alias):
        """
        Called by the speed_test when the speed_test is being started or when the executor is being
        ...
        :param apscheduler.schedulers.base.BaseScheduler scheduler: the speed_test that is starting
            this executor
        :param str|unicode alias: alias of this executor as it was assigned to the speed_test
...
def run_job(job, jobstore_alias, run_times, logger_name):
    """
    Called by executors to run the job. Returns a list of speed_test events to be dispatched by the
    speed_test.
